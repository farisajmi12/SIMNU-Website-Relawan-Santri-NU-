...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-danger deleteDonaturBtn"
                                                data-id="<?= $d->id ?>"
                                                data-toggle="modal"
                                                data-target="#deleteDonaturModal">
    ...
    <div class="modal fade" id="modalDonatur" tabindex="-1" role="dialog" aria-labelledby="modalDonaturLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?= base_url('admin/save_donatur') ?>" method="post">
    ...
    <!-- Modal Hapus Donatur -->
    <div class="modal fade" id="deleteDonaturModal" tabindex="-1" role="dialog" aria-labelledby="deleteDonaturModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" id="confirmDeleteDonaturBtn" class="btn btn-danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).on('click', '.deleteDonaturBtn', function() {
            const donaturId = $(this).data('id');
            $('#confirmDeleteDonaturBtn').attr('href', '<?= base_url("admin/delete_donatur/") ?>' + donaturId);
        });
    </script>

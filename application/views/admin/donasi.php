        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="list-group">
                    <a href="<?= base_url('admin/donatur'); ?>" class="list-group-item list-group-item-action">
                        <i class="fas fa-fw fa-users"></i> Donatur
                    </a>
                    <a href="<?= base_url('admin/jenis_donasi'); ?>" class="list-group-item list-group-item-action">
                        <i class="fas fa-fw fa-hand-holding-usd"></i> Jenis Donasi
                    </a>
                    <a href="<?= base_url('admin/penerimaan'); ?>" class="list-group-item list-group-item-action">
                        <i class="fas fa-fw fa-download"></i> Penerimaan
                    </a>
                    <a href="<?= base_url('admin/pengeluaran'); ?>" class="list-group-item list-group-item-action">

...
<body>
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="<?= base_url('operator/laporan') ?>">
          <div class="row">
          ...
          <div class="text-center">
            ...
            <a href="<?= base_url('operator/laporan') ?>" class="btn btn-secondary">
    ...
    <div class="container mb-4">
      <div class="row justify-content-center g-2">
        <div class="col-auto">
          <button type="button" class="btn btn-secondary" onclick="window.location.href='<?= base_url('operator/lkknu'); ?>'">
            <i class=""></i> Kembali
          </button>
        </div>
        <div class="col-auto">

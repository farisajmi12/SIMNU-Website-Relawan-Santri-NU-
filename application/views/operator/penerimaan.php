...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4 filter-card">
            ...
            <div class="card-body">
                <form method="get" action="<?= base_url('operator/penerimaan') ?>">
                    <div class="row">
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?= base_url('operator/penerimaan') ?>" class="btn btn-secondary">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="penerimaan_uang-tab" data-toggle="tab" href="#penerimaan_uang" role="tab">Penerimaan Uang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="penerimaan_barang-tab" data-toggle="tab" href="#penerimaan_barang" role="tab">Penerimaan Barang</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="penerimaan_uang" role="tabpanel" aria-labelledby="penerimaan_uang-tab">
                        <!-- Button Tambah -->
                        <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modalPenerimaanUang" onclick="resetFormUang()">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <button onclick="editDataUang(<?= htmlspecialchars(json_encode($p), ENT_QUOTES, 'UTF-8') ?>)"
                                                                    class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalPenerimaanUang">
                    ...
                    <div class="tab-pane fade" id="penerimaan_barang" role="tabpanel" aria-labelledby="penerimaan_barang-tab">
                        <!-- Button Tambah -->
                        <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modalPenerimaanBarang" onclick="resetFormBarang()">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <button onclick="editDataBarang(<?= htmlspecialchars(json_encode($b), ENT_QUOTES, 'UTF-8') ?>)"
                                                                    class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalPenerimaanBarang">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                            </div>
                                                        </td>
        ...
        <div class="modal fade" id="modalPenerimaanUang" tabindex="-1" role="dialog" aria-labelledby="modalPenerimaanUangLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('operator/save_penerimaan') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPenerimaanBarang" tabindex="-1" role="dialog" aria-labelledby="modalPenerimaanBarangLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="<?= base_url('operator/save_penerimaan') ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
    ...
    <script>
        ...
        function editDataUang(data) {
            ...
            // Show modal
            $('#modalPenerimaanUang').modal('show');
        }
